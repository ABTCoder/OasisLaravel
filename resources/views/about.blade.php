...
<div class="about-policy" >
    ...
    <div class="about_left">
        <div class="about_scopes">
            <p> Siamo un'azienda nata da meno di un anno, composta da 4 appassionati di tecnologia e studenti di Ingegneria Informatica e 
                dell'automazione presso l'Università Politecnica delle Marche.</p>
            <h1 class="scopes_title">Ci occupiamo della vendita di:</h1> 
        ...
        <div class="about_emails">
            ...
            <a href="mailto:s1082053@studenti.univpm.it ">Matteo Toma - s1082053@studenti.univpm.it</a> <br>
            <a href="mailto:s1081742@studenti.univpm.it ">Amal Benson Thaliath - s1081742@studenti.univpm.it</a> <br>
            <a href="mailto:s1083626@studenti.univpm.it ">Federico Joseph Panackal - s1083626@studenti.univpm.it</a> <br>
            <a href="mailto:s1081677@studenti.univpm.it">Giovanni Gregorini - s1081677@studenti.univpm.it</a>
        </div>
    </div>
