...
<div class="about-policy">
    ...
    <hr id="ap_divider">
    <h1 class="scopes_title_blue">ULTIMO AGGIORNAMENTO: 11 Giugno 2020</h1>
    <p>Questo sito raccoglie alcuni dati personali dei propri utenti.</p>
    <div class="scopes_title_blue2">Trattamento dei dati</div>
    ...
    <div class="scopes_title_blue2">Ulteriori informazioni sui Dati Personali</div>
    <div class="scopes_title2">Utilizzo di Cookie</div>
    <p class="more_one">
    ...
    <div class="scopes_title_blue2">Informazioni di contatto</div>
    <div class="iconed icon_owner" >
        <div class="scopes_title2">Titolare del Trattamento dei Dati</div>
        <p>Oasis s.r.l.
            <br>Via Brecce Bianche, 12, 60131 Ancona AN
            <br><b class="scopes_title2">Amministratori:</b> Matteo Toma, Giovanni Gregorini, Amal Benson Thaliath, Federico Joseph Panackal
