<div class="staff_sidenav">
    <div class="staffnav_items">
        ...
        <a href="{{ route('editproduct') }}"><img src="{{ asset('images/ui_images/edit_white.png') }}">Modifica prodotto</a><br>
        ...
        <a href="{{ route('deleteproduct') }}"><img src="{{ asset('images/ui_images/delete_white.png') }}">Elimina prodotto</a><br>
    </div>
</div>
