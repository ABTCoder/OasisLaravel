<nav id="topnav">
    ...
    <ul>
        ...
        <li class="{{ Route::is('howtobuy*') ? 'active' : '' }}"><a href="{{ route('howtobuy') }}">COME ACQUISTARE</a></li>
        ...
        <li class="{{ Request::is('staff*') ? 'active' : '' }}" id="staff"><a href="{{ route('staff') }}"> AREA STAFF</a></li>
